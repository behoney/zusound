    ...
    <div className="container mx-auto p-6">
      ...
      <div className="mb-8 p-6 border rounded bg-gray-50">
        ...
        <p className="mb-4">
          ...
          middleware. The WebGL visualizer is no longer a separate component but is now embedded
          *within* the dialog that appears automatically if the browser blocks audio playback due to
        ...
        <ol className="list-decimal pl-6 mb-4 space-y-1">
          <li>
            Ensure your browser's autoplay policy might block audio initially (often requires a page
            reload without prior interaction). You might need to clear site settings or use a fresh
            browser profile for testing this.
          </li>
          ...
          <li>
            If audio is blocked, a dialog should appear containing the visualizer, an explanation,
            and a button to enable audio. The visualizer inside the dialog will react to the button
            clicks.
          </li>
          <li>
            Clicking the "Enable Audio" button or interacting with the page should dismiss the
            dialog and allow sounds to play normally.
          </li>
        </ol>
        ...
        <div className="mt-6">
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Visualizer automatically appears within a dialog when audio is blocked (requires
              `persistVisualizer: true`).
            </li>
